...
<head>
    ...
    <title>Hostel View | Bonfinitics Makos </title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Hostel View</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table class="table-responcive table-bordered table-hover"> 
                                    <tr>
                                        <th>No of Rooms Completed</th>
                                        <td>45</td>                                        
                                    </tr>
                                    <tr>
                                    	<th>No of Rooms To Do</th>
                                        <td>27</td>                                       
                                    </tr>
                                    <tr>
                                    	<th>Rating</th>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner">
                                <table class="table-responcive table-bordered">
                                    <tr>
                                        <th>Day</th>
                                        <th>Slots</th>                                     
                                    </tr>
