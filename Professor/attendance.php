...
<body>
    ...
    <div class="all-content-wrapper">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Prof. Japesh Bagga Attendance Summary <span class="table-project-n"></span> </h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="action">No. Of Days Present</th>
                                                <th data-field="action">No. Of Days Absent</th>
										...
										<?php
											...
											$atd_query = "select atd_dept,atd_subject,atd_present_days,atd_absent_days,atd_total_days from attendance where (atd_faculty_name='Abcd' and atd_type='faculty')";
        ...
        <!-- Static Faculty Table End -->

        <!-- Static Student Table Start -->
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Student Attendance <span class="table-project-n"></span> </h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
												...
												?>
													<tr>
														...
														<td class="datatable-ct">
															<div class="bt-df-checkbox"> &nbsp; Present<input class="pull-left radio-checked" type="radio" checked="false" value="option1" id="optionsRadios1" name="optionsRadios"></div>
